...
pub fn unifies_divergent_iterator(array_or_range: bool) -> impl Iterator<Item = u8> {
    if array_or_range {
        Or2::T0([1u8, 2u8])
    } else {
        Or2::T1(0u8..10u8)
...
pub fn retrieves_a_value_dynamically(input: Or3<u8, usize, [char; 1]>) {
...
/// generically.
pub fn retrieves_a_value_statically(input: Or4<char, bool, isize, u32>) {
